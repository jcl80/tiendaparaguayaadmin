...
export interface ApiScrapingTaskScrapingTask extends Schema.CollectionType {
  collectionName: 'scraping_tasks';
  info: {
    displayName: 'Scraping Task';
    pluralName: 'scraping-tasks';
    singularName: 'scraping-task';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::scraping-task.scraping-task',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    error_logs: Attribute.Text;
    frecuency: Attribute.Enumeration<['daily', 'weekly', 'monthly']>;
    last_run: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
